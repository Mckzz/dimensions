...
#first pivots the width measurements to long, leaving the areas as they were in excel data entry doc
...
#then pivots the areas in widthlong to make the fully long form dataframe
...
#remove pH7 points because they are annoying on graph with jitter(not working, removes all rows no matter what I do)
